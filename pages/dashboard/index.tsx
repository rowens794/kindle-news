...
export default function Example({ articles, name, pastIssues }: Props) {
              ...
              <div className="mx-auto max-w-7xl px-4 sm:px-6 md:px-8">
                <div className="py-4">
                  ...
                  <div className="flex flex-wrap gap-4">
                    <CurrentEditionCard articles={articles} name={name} />
...
const CurrentEditionCard = ({ articles, name }: Props) => {
  return (
    <div className="aspect-[1/1.41421] select-none overflow-hidden bg-gray-100 w-64  border-gray-300 border shadow-lg rounded-sm flex flex-col justify-between">
      <div className="p-2">
        <div>
          <span className="text-xs text-indigo-600">Current Edition</span>
          <Link href="/dashboard/current-issue">
            <h2 className="text-base font-bold text-gray-700 line-clamp-2 hover:underline">
              {name}
            </h2>
          </Link>
        </div>
        ...
        <div className="ml-2 mt-2">
          ...
          <ul className="mt-2 list-disc text-xs ml-4 pr-2 marker:text-gray-600">
            ...
            {articles.length > 5 && (
              <Link href="/dashboard/current-issue">
                <p className="font-bold text-right w-full pr-4 text-indigo-600 hover:underline">
      ...
      <button className="w-full bg-indigo-500 hover:bg-indigo-600 py-4 rounded-b-sm">
        <p className="text-lg font-bold text-white">Deliver Now</p>
      </button>
    </div>
  );
};
...
const PastEditionCard = ({
  ...
  return (
    <div className="aspect-[1/1.41421] select-none overflow-hidden bg-gray-200 w-64  border-gray-300 border shadow-lg rounded-sm flex flex-col justify-between opacity-50 hover:opacity-100">
      <div className="p-2">
        <div>
