...
export default function handler(
  ...
  res.status(200).json({
    issues: [
      {
        articles: randomizeArray(articles),
        name: "The Old Philadelphia Inquirer",
        lastDelivered: new Date("6/21/2022"),
      },
      {
        articles: articles,
        name: "Boston's Great Newspaper",
        lastDelivered: new Date("1/14/2022"),
      },
      {
        articles: articles,
        name: "The Chocolate City Times",
        lastDelivered: new Date("8/31/2022"),
      },
      {
        articles: articles,
        name: "Bananarama Weekly",
        lastDelivered: new Date("9/7/2022"),
      },
    ],
  });
}
